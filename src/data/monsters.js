...
export const NORMAL_MONSTERS = [
  { id: 'm1', name: '草原史萊姆', title: '黏糊糊的', element: ELEMENTS.WOOD, isEmoji: false, icon: '🍄', image: 'monster_slime.png', prefHand: 'PAPER', stats: { hp: 500, maxHp: 500, atk: 33, def: 10 }, lore: '最常見的低級魔物，喜歡寄生在別人身上吸取養分。被收服後意外地適合拿來當抱枕。', skill1: { name: '寄生孢子', cost: 30, desc: '造成 10 傷害並施加 🌿[寄生] 2回合。' }, skill2: { name: '光合作用', cost: 60, desc: '回復自己 60 點生命值。' } },
  { id: 'm2', name: '巨石蟹', title: '硬邦邦的', element: ELEMENTS.WATER, isEmoji: false, icon: '🦀', image: 'monster_crab.png', prefHand: 'SCISSORS', stats: { hp: 650, maxHp: 650, atk: 35, def: 30 }, lore: '全身覆蓋堅硬岩石的螃蟹，防禦力驚人。生氣時會吐出冰封泡泡。', skill1: { name: '硬化', cost: 30, desc: '獲得 50 點護盾。' }, skill2: { name: '泡泡光線', cost: 60, desc: '造成 40 傷害並施加 ❄️[封印] 1回合。' } },
  { id: 'm3', name: '爆炎犬', title: '熱騰騰的', element: ELEMENTS.FIRE, isEmoji: false, icon: '🐕', image: 'monster_dog.png', prefHand: 'ROCK', stats: { hp: 540, maxHp: 540, atk: 60, def: 12 }, lore: '性格暴躁的犬型魔物，全身燃燒著火焰，咬合力極強。收服後冬天可以用來當暖爐。', skill1: { name: '火焰牙', cost: 30, desc: '造成 20 傷害並施加 🔥[燃燒] 2回合。' }, skill2: { name: '地獄火', cost: 70, desc: '造成高達 80 點傷害。' } },
  ...
  { id: 'm8', name: '熔岩蜥蜴', title: '滾燙的', element: ELEMENTS.FIRE, isEmoji: false, icon: '🦎', image: 'monster_lizard.png', prefHand: 'ROCK', stats: { hp: 560, maxHp: 560, atk: 46, def: 18 }, lore: '棲息於火山岩漿地帶的蜥蜴型魔物。表皮由凝固岩漿構成，蓄積熱能後能引爆全身造成毀滅性衝擊。', skill1: { name: '熔甲防禦', cost: 35, desc: '獲得 60 點護盾。' }, skill2: { name: '熔岩爆裂', cost: 70, desc: '消耗所有護盾，造成 40 加護盾等量的真實傷害。' } },
  { id: 'm9', name: '星晶鷺鳥', title: '輕盈飛翔的', element: ELEMENTS.LIGHT, isEmoji: false, icon: '🦢', image: 'monster_heron.png', prefHand: 'SCISSORS', stats: { hp: 500, maxHp: 500, atk: 52, def: 12 }, lore: '翅膀結晶化的光屬性鳥型魔物，飛行速度極快。振翅產生的光芒能令對手陷入眩目。', skill1: { name: '星光羽翼', cost: 30, desc: '獲得 ⚡[亢奮] 3回合，並獲得 30 點護盾。' }, skill2: { name: '天光衝擊', cost: 60, desc: '造成 55 傷害，並強制對手下回 💫[強制出拳]。' } },
...
export const BOSS_MONSTERS = [
  { id: 'b1', name: '災厄黑龍', title: '深淵霸主', element: ELEMENTS.DARK, isEmoji: false, icon: '🐉', image: 'boss_dragon.png', prefHand: 'ROCK', stats: { hp: 1300, maxHp: 1300, atk: 80, def: 35 }, lore: '盤踞在廢棄古城的巨龍，擁有毀滅性的吐息，被認為是大星晶碎裂的罪魁禍首之一。', skill1: { name: '龍威', cost: 40, desc: '扣除 20 能量並施加 🤐[沉默] 1回合。' }, skill2: { name: '毀滅吐息', cost: 90, desc: '無視護盾造成 150 點傷害。' } },
  { id: 'b2', name: '耀光大天使', title: '天界審判', element: ELEMENTS.LIGHT, isEmoji: false, icon: '👼', image: 'boss_angel.png', prefHand: 'PAPER', stats: { hp: 1200, maxHp: 1200, atk: 85, def: 30 }, lore: '原本是守護神殿的天使，卻被過度純粹的光之能量逼瘋，對所有入侵者降下無差別的神罰。', skill1: { name: '致盲之光', cost: 40, desc: '施加 💫[眩目] 1回合，並獲得 30 護盾。' }, skill2: { name: '神罰', cost: 90, desc: '造成 130 點直接傷害。' } },
  { id: 'b3', name: '獄炎魔王', title: '焦熱地獄', element: ELEMENTS.FIRE, isEmoji: false, icon: '🌋', image: 'boss_demon.png', prefHand: 'ROCK', stats: { hp: 1350, maxHp: 1350, atk: 90, def: 25 }, lore: '從火山深處誕生的炎之惡魔，企圖將整個世界化為焦熱地獄。', skill1: { name: '沸騰之血', cost: 40, desc: '提升自身 10 攻擊力，並施加 🔥[燃燒] 2回合。' }, skill2: { name: '天地灰燼', cost: 100, desc: '造成 180 點毀滅性傷害。' } },
  { id: 'b4', name: '森之巨神', title: '萬古腐化', element: ELEMENTS.WOOD, isEmoji: false, icon: '🌳', image: 'boss_tree.png', prefHand: 'PAPER', stats: { hp: 1500, maxHp: 1500, atk: 70, def: 45 }, lore: '被腐化力量侵蝕的遠古樹神，其寄生藤蔓能瞬間吸乾整座森林的生命力。', skill1: { name: '寄生藤蔓', cost: 40, desc: '造成 30 傷害並施加 🌿[寄生] 3回合。' }, skill2: { name: '萬物歸一', cost: 80, desc: '瞬間回復 200 點生命值。' } },
  { id: 'b5', name: '冰霜巨龍', title: '絕對零度', element: ELEMENTS.WATER, isEmoji: false, icon: '❄️', image: 'boss_icedragon.png', prefHand: 'SCISSORS', stats: { hp: 1200, maxHp: 1200, atk: 75, def: 55 }, lore: '沉睡在冰川下的古老存在，其吐息能帶來絕對零度的冰河時代。', skill1: { name: '冰霜裝甲', cost: 40, desc: '獲得高達 80 點的護盾。' }, skill2: { name: '冰河時代', cost: 90, desc: '造成 100 傷害，清空能量並施加 ❄️[封印] 1回合。' } },
];
